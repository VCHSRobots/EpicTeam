...
echo "<br>";
echo "<textarea rows=\"4\" cols=\"50\" placeholder=\"Description\" name=\"Description\">";
echo "</textarea>";
echo "<br>";
echo "<br>";
echo "Workorder due date:  <select name=\"DueDay\">";
...
echo "<option value=\"3D Printing\">3D Printing</option>";
echo "<option value=\"Business\">Business</option>";
echo "<option value=\"Logistics\">Logistics</option>";
echo "<option value=\"Strategy\">Strategy / Systems</option>";
