<?php
// --------------------------------------------------------------------
// wo_delete_form.php -- UI for WO Delete
//
...
if($doform)
{
	echo '<div id="wo_delete_form" class="inputform_area">' . "\n";
	echo '<form action="wo_delete.php" method="post">' . "\n";
	RenderParams($param_list, "wo_delete_");
